...
export function Contact() {
  ...
  const socialLinks = [
    { href: personalInfo.github, Icon: GitHubIcon, id: "contact-github", label: "GitHub" },
    { href: personalInfo.linkedin, Icon: LinkedInIcon, id: "contact-linkedin", label: "LinkedIn" },
    { href: personalInfo.twitter, Icon: XIcon, id: "contact-twitter", label: "Twitter / X" },
    { href: `mailto:${personalInfo.email}`, Icon: Mail, id: "contact-mail", label: "Email" },
    ...(whatsappNumber
      ? [{ href: `https://wa.me/${whatsappNumber.replace(/\D/g, "")}`, Icon: WhatsAppIcon, id: "contact-whatsapp", label: "WhatsApp" }]
      : []),
  ];
